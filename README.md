...
আপনার রিপোজিটরির Settings > Secrets and variables > Actions-এ যান এবং নিচের ৪টি New repository secret অ্যাড করুন:
Secret Name	Value (উদাহরণ)
SSH_HOST	your-server-ip অথবা yourdomain.com
SSH_USER	demosashik
SSH_PORT	22 (cPanel-এর ক্ষেত্রে ভিন্ন হতে পারে)
SSH_PRIVATE_KEY	cat ~/.ssh/id_ed25519 এর আউটপুট
সতর্কতা: Private Key-টি শুরু থেকে শেষ পর্যন্ত (বিগিন এবং এন্ড লাইনসহ) সম্পূর্ণ কপি করবেন।
...
আপনার প্রোজেক্টের রুটে .github/workflows/deploy.yml ফাইলটি তৈরি করুন এবং নিচের কোডটি পেস্ট করুন:
code
Yaml
    ...
    steps:
      ...
      - name: Deploy on Server
        run: |
          ...
          EOF
✅ ধাপ ৬: টেস্ট করা
এখন আপনার লোকাল কম্পিউটার থেকে কোডটি git push করুন। GitHub-এর Actions ট্যাবে গিয়ে দেখুন সব স্টেপ সবুজ (Success) দেখাচ্ছে কি না।
⚠️ সাধারণ কিছু প্রশ্ন (FAQ)
১. Node.js deprecation warning কেন আসছে?
এটি GitHub Actions-এর ইন্টারনাল ওয়ার্নিং, আপনার লারাভেল প্রোজেক্টের কোনো সমস্যা নয়। এটি ইগনোর করা যায়।
২. কোড পুশ করার পর সার্ভারে আপডেট হচ্ছে না কেন?
আপনার YAML ফাইলে cd এর পর দেওয়া ফোল্ডার পাথটি আপনার সার্ভারের পাথের সাথে মিলছে কি না চেক করুন।
Author: MD Ashik
Topic: Laravel CI/CD with cPanel SSH (Bangla Guide)
আপনি এই টাইটেলটি দিতে পারেন:
"Laravel CI/CD with cPanel SSH - Bangla Guide"
অথবা একটু ক্যাচি করতে চাইলে:
